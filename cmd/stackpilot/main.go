...
func writeUsage(output io.Writer) {
	...
	fprintln(output, "  metrics  Read bounded service resource metrics")
	fprintln(output, "  plan     Create a read-only running-to-workspace change plan")
	fprintln(output, "  verified-restart  Restart against an immutable plan and verify stability")
