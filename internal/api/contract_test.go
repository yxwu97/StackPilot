...
func TestOpenAPIContractMatchesRoutesAndErrorRegistry(t *testing.T) {
	...
	for _, path := range []string{
		...
		"/api/v1/workspaces/{workspaceId}/metrics", "/api/v1/workspaces/{workspaceId}/revisions",
		"/api/v1/revisions/{revisionId}", "/api/v1/workspaces/{workspaceId}/change-plans",
		"/api/v1/change-plans/{changePlanId}", "/api/v1/workspaces/{workspaceId}/verified-restart",
		"/api/v1/operations",
